...
def main():
    ...
    db.execute("CREATE TABLE reviews (id SERIAL PRIMARY KEY, book_id INTEGER NOT NULL, username VARCHAR UNIQUE NOT NULL, review_text VARCHAR NOT NULL, review_score INTEGER NOT NULL)")
